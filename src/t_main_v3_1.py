    ...
    def log_env_metrics(self, episode, env_info, action, state, config):
        ...
        try:
            ...
            if episode % 10 == 0:  # Print every 10th episode to avoid spam
                print(f"DEBUG Episode {episode}: served={env_info.get('served', 0)}, latency={env_info.get('total_latency', 0):.2f}, flops={env_info.get('total_flops', 0):.2f}, mem={env_info.get('total_mem', 0):.2f}")
...
if __name__ == "__main__":
    ...
    if args.env_name == 'gail-service-env':
        ...
        from env.env_v3_org_v1 import GAIServiceEnv_v1 as GAIServiceEnv, EnvConfig_v1 as EnvConfig
